...
/**
 * F\Restful\Server\Adapter\Native is
 * the native adapter for the server service,
...
/**
 * @see F/Restful/Server/Adapter/Definition.php
 */
require_once 'F/Restful/Server/Adapter/Definition.php';

/**
 * F\Restful\Server\Adapter\Native is the native adapter
 * for the server service, that implements PHP natives primitives.
 *
 * @category   F
 * @package    F\Restful\Server\Adapter
 * @copyright  Copyright (c) 2012 <COPYRIGHT>
    ...
    implements Definition
{
	public function dispatch($request)
	{
		throw new \RuntimeException (
			"Feature '" . __METHOD__ . "' not yet implemented in Native Adapter"
		);
	}
