 ...
 */
class TechnicalDatabaseInteTest
    extends \F\Technical\Base\Test\Integration\Service
{
    ...
    public function testFetchAllWithNoParamSuccess()
    {
        ...
        $actual = $this->s()->fetchAll($sql);
        $this->assertEquals($this->getResultSet(__FUNCTION__),
                            json_encode($actual));
    }
    ...
    public function testUpdateWithSuccessReturnNbUpdated()
    {
        $this->connectDatabase();
    ...
    public function testUpdateWithNoWhereClauseSuccessNbUpdated()
    {
        $this->connectDatabase();
        $data = array('name' => "Marauder", 'type' => "biomecha", 'year' => 2052);
    ...
    public function testDeleteWithSuccessReturnNbDeleted()
    {
        $this->connectDatabase();
    	$where = array('name = %{name} AND `type` = %{type}', array ('name' => "goldorak", 'type' => "mechanical"));
    ...
    public function testDeleteWithNoWhereSuccessReturnNbDeleted()
    {
        $this->connectDatabase();
